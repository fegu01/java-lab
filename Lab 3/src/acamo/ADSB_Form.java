...
public class ADSB_Form extends JFrame implements ActionListener
{
    ...
    public void createPage1()
    {
        ...
        DefaultListCellRenderer list1Renderer = new DefaultListCellRenderer();
        list1Renderer.setForeground(new Color(200,100,100));
        list1Renderer.setVisible(true);
        list1.setPreferredSize(new Dimension(600,400));
        list1.setCellRenderer(list1Renderer);
    ...
    public void createPage2()
    {
        ...
        list2.setPreferredSize(new Dimension(600,400));
    ...
    public void createPage3()
    {
        ...
        list3.setPreferredSize(new Dimension(600,400));
    }
    ...
    public void createPage4()
    {
        ...
        list4.setPreferredSize(new Dimension(600,400));
